...
CREATE TABLE detalle_carrito (
    ...
    tallaSeleccionada VARCHAR(50) NULL DEFAULT NULL,
...
CREATE TABLE pedido (
    ...
    direccion_departamento VARCHAR(100),
    direccion_codigo_postal VARCHAR(20),
    direccion_telefono VARCHAR(30),
    direccion_referencias VARCHAR(255),
...
('PRD002', 'Camiseta Estampada Urban', 'Camiseta con diseno urbano moderno, tejido suave y resistente.', 79900.00, 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=500&h=500&fit=crop', 'CAT001'),
('PRD003', 'Camiseta Polo Classic', 'Polo elegante de pique con cuello y botones.', 99900.00, 'https://images.unsplash.com/photo-1586790170083-2f9ceadc732d?w=500&h=500&fit=crop', 'CAT001'),
...
('PRD007', 'Vestido Floral Verano', 'Vestido ligero con estampado floral.', 139900.00, 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=500&h=500&fit=crop', 'CAT003'),
('PRD008', 'Vestido Elegante Negro', 'Vestido negro de corte elegante.', 259900.00, 'https://armatura.com.co/cdn/shop/files/Vestido_tejido_negro_contexto.webp?v=1722539161', 'CAT003'),
