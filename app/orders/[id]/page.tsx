                ...
                {pedido.detalles?.map((detalle) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {detalle.tallaSeleccionada && (
                        <p className="text-sm text-muted-foreground">
                          Talla: {detalle.tallaSeleccionada}
                        </p>
                      )}
                      <p className="text-sm text-muted-foreground">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Precio unitario: {formatPrice(detalle.precio)}
                      </p>
                    </div>
                    <p className="font-semibold">
                      {formatPrice(detalle.precio * detalle.cantidad)}
                    </p>
                  </div>
                ))}
              </div>
          ...
          {pedido.direccion_envio && (
            <Card>
              ...
              <CardContent className="space-y-2">
                <p className="font-medium">{pedido.direccion_envio.calle}</p>
                <p className="text-sm text-muted-foreground">
                  {pedido.direccion_envio.ciudad}, {pedido.direccion_envio.departamento}
                </p>
                <p className="text-sm text-muted-foreground">
                  CP {pedido.direccion_envio.codigo_postal}
                </p>
                <p className="text-sm text-muted-foreground">
                  Teléfono: {pedido.direccion_envio.telefono}
                </p>
                {pedido.direccion_envio.referencias && (
                  <p className="text-sm text-muted-foreground">
                    Referencias: {pedido.direccion_envio.referencias}
                  </p>
                )}
              </CardContent>
            </Card>
